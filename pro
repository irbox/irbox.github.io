...
<html class="dark">
  <head data-build="48353">
    ...
    <meta charset="utf-8"><title>PRO Membership</title>

    <link rel="shortcut icon" href="/img/favicon.png" type="image/x-icon">
    <link rel="stylesheet" href="/svelte/index.214a39cf.css" />
    <script type="module" defer src="/svelte/index.1de9d119.js" /></script>
    ...
    <link rel="canonical" href="https://fireship.io/pro/" />

    <meta name="description" content="Upgrade to a pro membership">
    <meta name="image" content="https://fireship.io/img/default-cover.png"><meta property="og:title" content="PRO Membership" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://fireship.io/pro/" />
    <meta property="og:image" content="https://fireship.io/img/default-cover.png" />
    <meta property="og:description" content="Upgrade to a pro membership" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:site" content="@fireship_dev">
    <meta name="twitter:title" content="PRO Membership">
    <meta name="twitter:description" content="Upgrade to a pro membership">
  ...
  <body>
    ...
    <global-data 
    permalink="https://fireship.io/pro/" 
    vimeo=""
    youtube=""
    free=""
    next="https://fireship.io/success/" 
    prev="https://fireship.io/get-started/">
  </global-data>
...
<g class="fk-group"><path fill="currentColor" d="M208 80a128 128 0 1 1-90.51 37.49A127.15 127.15 0 0 1 208 80m0-80C93.12 0 0 93.12 0 208s93.12 208 208 208 208-93.12 208-208S322.88 0 208 0z" class="fk-secondary"></path><path fill="currentColor" d="M504.9 476.7L476.6 505a23.9 23.9 0 0 1-33.9 0L343 405.3a24 24 0 0 1-7-17V372l36-36h16.3a24 24 0 0 1 17 7l99.7 99.7a24.11 24.11 0 0 1-.1 34z" class="fk-primary">
  ...
  <main class="container prose dark:prose-invert p-8">
    
    
<header class="text-center max-w-lg mx-auto">
    <h1>Become an <span class="gradient-text-pink">awesome</span> developer</h1>
    <p class="text-lg text-gray4">Learn the essential skills for modern fullstack app development while having 
        <modal-action type="open" name="meme"><strong class="text-green-400 font-black underline cursor-pointer"></modal-trigger>tons of fun</strong> in the process.
    </p>
    <if-pro>
        <div slot="pro" class="rounded-lg p-6 bg-gray6 mb-8">
            <h3 class="text-green-500 mt-1">🦄 You are a pro member!</h3>
...
<div class="flex flex-col md:flex-row md:items-stretch text-center justify-center items-center mx-auto">

    <div class="flex flex-col items-center justify-center bg-gray6 rounded-xl shadow-xl border-y-8 border-orange-500 p-6 w-full md:w-1/3 m-2 max-w-md">
        <h5 class="text-orange-300">Plan</h5>
        <div>
            <span class="text-3xl font-light">$</span>
            <span class="text-6xl font-display gradient-text"><price-select /></span>
            <div class="mt-3">
                <price-select show="control"></price-select>
            </div>
        </div>
        <ul class="list-none text-left p-0 w-xl my-auto">
            <li class="check-green">Unlimited access to PRO courses</li>
            <li class="check-green">Quizzes with hand-picked meme prizes</li>
            <li class="check-green">Invite to private Discord chat</li>
            <li class="check-green">30-day moneyback guarantee</li>
            <li class="check-logo">Free Sticker mailed to your door</li>
        </ul>

        <buy-pro></buy-pro>
    </div>

    <div class="flex flex-col items-center justify-center bg-gray6 rounded-xl shadow-xl border-y-8 border-green-500 p-6 w-full md:w-1/3 m-2 max-w-md">
        <h5 class="text-green-300">Lifetime</h5>
        <div>
            <span class="text-3xl font-light">$</span>
            <span class="text-6xl font-display gradient-text-green">399</span>
            <span>once</span>
        </div>
        <ul class="list-none p-0 text-left my-auto">
            <li class="check-green">All PRO-tier benefits</li>
            <li class="check-green">Single payment, lifetime access</li>
            <li class="check-green">4,200 bonus xp points</li>
            <li class="check-green">30-day moneyback guarantee</li>
            <li class="check-logo">Next Level <modal-action type="open" name="tshirt" class="underline cursor-pointer">T-shirt</modal-action> shipped worldwide</li>
        </ul>
...
<modal-dialog name="tshirt" esc="true">
    <img class="max-w-md mx-auto" src="/img/tshirt.png" alt="Fireship T-shirt">
...
<div class="flex flex-col text-center justify-center items-center mx-auto">
    ...
    <p class="text-lg text-gray4 max-w-lg">Looking to signup of 5 seats or more? Get a big discount with personalized video call setup</p>

    <div class="flex flex-col items-center justify-center bg-gray6 rounded-xl shadow-xl border-y-8 border-blue-500 p-6 w-full md:w-1/3 m-2 max-w-md">
        <h5 class="text-blue-300">Enterprise</h5>
        <div>
            <span class="text-3xl font-light">$</span>
            <span class="text-6xl font-display text-blue-500">299</span>
            <span>/seat</span>
        </div>
        <ul class="list-none text-left p-0 w-xl">
            <li class="check-green">Everything from the Lifetime Plan</li>
            <li class="check-green">Better bulk pricing</li>
            <li class="check-green">5 seat minimum purchase</li>
            <li class="check-logo">Zoom walkthrough with Jeff</li>
        </ul>

        <buy-lifetime enterprise="true"></buy-lifetime>
    </div>
</div>
