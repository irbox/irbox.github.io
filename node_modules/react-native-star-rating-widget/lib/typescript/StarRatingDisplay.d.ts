...
declare const StarRatingDisplay: ({ rating, maxStars, starSize, color, emptyColor, style, starStyle, StarIconComponent, testID, accessibilityLabel, }: Props) => JSX.Element;
